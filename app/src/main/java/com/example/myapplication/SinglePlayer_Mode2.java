...
public class SinglePlayer_Mode2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_player_mode2);
        final TextView sure = (TextView) findViewById(R.id.sure_2);
        ...
        GridLayout gl = (GridLayout) findViewById(R.id.gridLayout2);
        for(int j=1;j<=4;j++) {
        ...
        say = new CountDownTimer(46000,1000) {
            ...
            public void onFinish() {
                ...
                Intent Game_over=new Intent(SinglePlayer_Mode2.this,Game_over.class);
    ...
    public void  tikla(View v){
        Kart k = (Kart)v;
        k.cevir();
        TextView tv = (TextView) findViewById(R.id.skor2);
        TextView sure = (TextView) findViewById(R.id.sure_2);
        ...
        if(sonkart!=0){
            ...
            if(k2.isim==k.isim && (k.getId()!=k2.getId())){
                ...
                //buraya muzik konacak kart eşleştirildi
